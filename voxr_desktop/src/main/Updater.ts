...
const UPDATE_API_ENDPOINT = BUILD_CHANNEL === 'canary' ? 'https://api.canary.voxr.app' : 'https://api.voxr.app';
...
const DOWNLOAD_PAGE_URL =
	BUILD_CHANNEL === 'canary' ? 'https://canary.voxr.app/download' : 'https://voxr.app/download';
...
function getArtifactProductName(): string {
	return BUILD_CHANNEL === 'canary' ? 'Voxr-Canary' : 'Voxr';
}
