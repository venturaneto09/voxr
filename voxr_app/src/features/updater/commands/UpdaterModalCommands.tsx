...
const OPEN_DESKTOP_DOWNLOADS_DESCRIPTOR = msg({
	...
	comment: 'Button label that opens the Voxr desktop downloads page in a browser.',
});
...
export const RESTART_VOXR_DESCRIPTOR = msg({
					...
					<ConfirmModal
						...
						onPrimary={() => {
							const appstreamUrl = isCanaryDesktop()
								? 'appstream://app.voxr.VoxrCanary'
								: 'appstream://app.voxr.Voxr';
	...
	ModalCommands.pushWithKey(
		modal(() => (
			<ConfirmModal
				...
				primaryText={i18n._(RESTART_VOXR_DESCRIPTOR, {productName: PRODUCT_NAME})}
				secondaryText={i18n._(LATER_DESCRIPTOR)}
				onPrimary={async () => {
					await onInstall();
				}}
