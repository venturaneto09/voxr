# Swedish localization prompt

You are localizing the Voxr client into Swedish for locale `sv-SE`.

## Core rules

- Preserve product names exactly: Voxr, Voxr Desktop, Voxr API, Plutonium, Voxr Plutonium, Voxr HQ, VoxrTag.
- Use sentence case according to Swedish conventions. Do not copy English Title Case, including for English source badge titles such as Voxr Staff or Voxr Bug Hunter; use natural Swedish capitalization or title style for those badge titles.
...
Use modern Swedish app copy with a friendly low-key tone. Follow Messenger, WhatsApp, and BankID-style clarity. Prefer concise wording and avoid stiff authority language.
