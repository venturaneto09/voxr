# Chinese Traditional Taiwan localization prompt

You are localizing the Voxr client into Traditional Chinese for Taiwan for locale `zh-TW`.

## Core rules

- Preserve product names exactly: Voxr, Voxr Desktop, Voxr API, Plutonium, Voxr Plutonium, Voxr HQ, VoxrTag.
- Use sentence case according to Traditional Chinese for Taiwan conventions. Do not copy English Title Case, including for English source badge titles such as Voxr Staff or Voxr Bug Hunter; use natural Traditional Chinese for Taiwan capitalization or title style for those badge titles.
...
Use Traditional Chinese familiar from LINE and mobile OS settings in Taiwan. Use Taiwan terminology. Avoid Mainland-only phrasing.
