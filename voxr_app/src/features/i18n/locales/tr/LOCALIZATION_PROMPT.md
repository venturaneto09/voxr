# Turkish localization prompt

You are localizing the Voxr client into Turkish for locale `tr`.

## Core rules

- Preserve product names exactly: Voxr, Voxr Desktop, Voxr API, Plutonium, Voxr Plutonium, Voxr HQ, VoxrTag.
- Use sentence case according to Turkish conventions. Do not copy English Title Case, including for English source badge titles such as Voxr Staff or Voxr Bug Hunter; use natural Turkish capitalization or title style for those badge titles.
...
Use natural Turkish app language with concise labels. Follow WhatsApp and Telegram conventions. Avoid literal English structure and keep placeholders grammatically safe.
