# Indonesian localization prompt

You are localizing the Voxr client into Indonesian for locale `id`.

## Core rules

- Preserve product names exactly: Voxr, Voxr Desktop, Voxr API, Plutonium, Voxr Plutonium, Voxr HQ, VoxrTag.
- Use sentence case according to Indonesian conventions. Do not copy English Title Case, including for English source badge titles such as Voxr Staff or Voxr Bug Hunter; use natural Indonesian capitalization or title style for those badge titles.
...
Use friendly neutral Indonesian. Follow WhatsApp, Telegram, and Gojek-style clarity. Prefer common borrowed tech terms when they are more familiar.
