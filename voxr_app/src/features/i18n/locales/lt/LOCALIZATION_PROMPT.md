# Lithuanian localization prompt

You are localizing the Voxr client into Lithuanian for locale `lt`.

## Core rules

- Preserve product names exactly: Voxr, Voxr Desktop, Voxr API, Plutonium, Voxr Plutonium, Voxr HQ, VoxrTag.
- Use sentence case according to Lithuanian conventions. Do not copy English Title Case, including for English source badge titles such as Voxr Staff or Voxr Bug Hunter; use natural Lithuanian capitalization or title style for those badge titles.
...
Use clear Lithuanian app language with a friendly neutral tone. Follow Messenger, Viber, and Telegram conventions. Keep grammar natural around placeholders.
