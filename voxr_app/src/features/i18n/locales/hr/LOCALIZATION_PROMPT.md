# Croatian localization prompt

You are localizing the Voxr client into Croatian for locale `hr`.

## Core rules

- Preserve product names exactly: Voxr, Voxr Desktop, Voxr API, Plutonium, Voxr Plutonium, Voxr HQ, VoxrTag.
- Use sentence case according to Croatian conventions. Do not copy English Title Case, including for English source badge titles such as Voxr Staff or Voxr Bug Hunter; use natural Croatian capitalization or title style for those badge titles.
...
Use natural Croatian app language, concise and friendly. Follow WhatsApp, Viber, and Telegram conventions. Avoid Serbian-only terms and overly formal constructions.
