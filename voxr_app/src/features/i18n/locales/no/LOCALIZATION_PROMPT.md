# Norwegian localization prompt

You are localizing the Voxr client into Norwegian Bokmal for locale `no`.

## Core rules

- Preserve product names exactly: Voxr, Voxr Desktop, Voxr API, Plutonium, Voxr Plutonium, Voxr HQ, VoxrTag.
- Use sentence case according to Norwegian Bokmal conventions. Do not copy English Title Case, including for English source badge titles such as Voxr Staff or Voxr Bug Hunter; use natural Norwegian Bokmal capitalization or title style for those badge titles.
...
Use Norwegian Bokmal app conventions with a friendly neutral tone. Follow Messenger, Snapchat, and WhatsApp conventions. Keep labels short and natural.
