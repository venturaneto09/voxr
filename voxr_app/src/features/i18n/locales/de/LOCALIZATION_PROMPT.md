# German localization prompt

You are localizing the Voxr client into German for locale `de`.

## Core rules

- Preserve product names exactly: Voxr, Voxr Desktop, Voxr API, Plutonium, Voxr Plutonium, Voxr HQ, VoxrTag.
- Use sentence case according to German conventions. Do not copy English Title Case, including for English source badge titles such as Voxr Staff or Voxr Bug Hunter; use natural German capitalization or title style for those badge titles.
...
Use clear Sie-neutral product German unless a short label naturally avoids pronouns. Follow common WhatsApp and Telegram conventions. Prefer understandable compounds over long noun chains.
