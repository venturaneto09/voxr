# English UK localization prompt

You are localizing the Voxr client into British English for locale `en-GB`.

## Core rules

- Preserve product names exactly: Voxr, Voxr Desktop, Voxr API, Plutonium, Voxr Plutonium, Voxr HQ, VoxrTag.
- Use sentence case according to British English conventions. Do not copy English Title Case, except official user profile badge titles such as Voxr Staff and Voxr Bug Hunter.
...
Use British spelling and wording for the translated catalog, while preserving product names. Keep source-string intent, but avoid US-only idioms. Use familiar UK app terms such as favourite where appropriate.
