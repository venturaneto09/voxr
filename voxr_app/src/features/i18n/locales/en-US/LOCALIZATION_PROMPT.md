# English US localization prompt

You are localizing the Voxr client into American English for locale `en-US`.

## Core rules

- Preserve product names exactly: Voxr, Voxr Desktop, Voxr API, Plutonium, Voxr Plutonium, Voxr HQ, VoxrTag.
- Use sentence case according to American English conventions. Do not copy English Title Case, except official user profile badge titles such as Voxr Staff and Voxr Bug Hunter.
...
Treat this as source-copy QA. Keep American spelling, sentence case, shared terms, and placeholders. Improve clarity without adding corporate polish.
