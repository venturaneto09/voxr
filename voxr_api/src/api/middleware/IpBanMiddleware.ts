...
import {getSameIpDecisionKey, type IpAddressFamily} from '@voxr/ip_utils/src/IpAddress';
...
class IpBanCache {
	...
	private startPeriodicRefresh(): void {
		...
		const intervalMs = Number(process.env.VOXR_IP_BAN_REFRESH_INTERVAL_MS ?? '300000');
