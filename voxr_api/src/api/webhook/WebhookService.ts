...
import {MAX_WEBHOOKS_PER_CHANNEL, MAX_WEBHOOKS_PER_GUILD} from '@voxr/constants/src/LimitConstants';
import {MaxWebhooksPerChannelError} from '@voxr/errors/src/domains/channel/MaxWebhooksPerChannelError';
...
import {MaxWebhooksPerGuildError} from '@voxr/errors/src/domains/guild/MaxWebhooksPerGuildError';
import {UnknownWebhookError} from '@voxr/errors/src/domains/webhook/UnknownWebhookError';
...
import type {InstatusWebhook} from '@voxr/schema/src/domains/webhook/InstatusWebhookSchemas';
import type {
	WebhookCreateRequest,
	WebhookMessageRequest,
	WebhookTokenUpdateRequest,
	WebhookUpdateRequest,
} from '@voxr/schema/src/domains/webhook/WebhookRequestSchemas';
...
const WEBHOOK_AVATAR_MISSING_CACHE_VALUE = '__voxr_webhook_avatar_missing__';
